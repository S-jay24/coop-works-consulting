        ...
        <div className="footer-grid" style={{paddingBottom:'3rem',borderBottom:'1px solid rgba(255,255,255,0.06)',marginBottom:'2rem'}}>
          <div className="footer-brand-col">
            <div style={{display:'flex',alignItems:'center',gap:8,marginBottom:'0.75rem'}}>
              <img src="/crowned-apex-mark-inverted.svg" alt="Coop Works Logo" style={{display:'block',width:'auto',height:24,objectFit:'contain'}}/>
              <div style={{fontFamily:'"Playfair Display",serif',fontWeight:700,fontSize:'1.1rem',color:'#fff'}}>Coop Works<span style={{color:C.amber}}> Consulting</span></div>
            </div>
